...
function Video(){
    ...
    <img className="logo"src="https://media.istockphoto.com/id/1348212541/photo/red-play-icon-button-on-white-background-social-media-and-sign-concept-3d-illustration.webp?b=1&s=612x612&w=0&k=20&c=DWQqBuuxy9BKExCifmW2Hk8X5Z6DZR4sZKzK57iOWI8=" alt="Youtube_logo"></img>
    <h1>YOUTUBE</h1>
    <input className="input" type="textfield" placeholder="ENTER ANY TEXT TO SEARCH"></input>
    <img className="search" src="https://cdn-icons-png.flaticon.com/128/751/751463.png" alt="search"></img>

    <img className="search" src="https://image.shutterstock.com/image-vector/microphone-icon-vector-flat-design-260nw-352036334.jpg" alt="microphone"></img>

    <img className="profile"  src="https://cdn-icons-png.flaticon.com/128/3135/3135715.png" alt="profile_pic"></img>

    <img className="bell" src="https://t4.ftcdn.net/jpg/01/08/24/99/240_F_108249947_UMBLfSCpTWU6AGiUz0F7a524koG3eO0z.jpg" alt="subscribers"></img>

    <img className="bell" src="https://cdn-icons-png.flaticon.com/128/12662/12662839.png" alt="recordings"></img>
    </div>
